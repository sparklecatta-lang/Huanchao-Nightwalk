...
**[立即下载 Windows 版](https://github.com/sparklecatta-lang/Huanchao-Nightwalk/releases/latest)** · **[查看本次更新](https://github.com/sparklecatta-lang/Huanchao-Nightwalk/releases/tag/v0.43.2)**
...
- 只有空中主动按 Q（手柄 X）才触发下砸伤害、冲击特效与重击音效。普通跳跃或高处落地不触发下砸。
- 黄猫脚步更换为提供的两段轻脚步声，按左右脚实际落地交替播放，保留主角最高音效优先级。
- 修复图鉴物品纸底盖住怪物墨绘的问题。
...
1. 打开上方下载页，下载 `Huanchao-Nightwalk-v0.43.2-Windows-x64.zip`。
...
| 空中下砸 | 跃起达到一定高度后按 Q；普通落地不触发 | 跃起达到一定高度后按 X；普通落地不触发 |
...
修复怪物画像被物品图标纸底遮挡的问题。切换怪物、法器和物件分类时，图标与底纸会一起显示或隐藏；十二张墨绘原图保持。
...
本仓库提供 Windows 可玩程序、更新说明与展示配图。当前发布版本为 **v0.43.2**。
